...
VERSION = APP_VERSION
APP_BUILD = "Fjord VI 1.11.2"
RELEASE_LABEL = "Fjord VI · v1.11.2"
...
def system_console_context(db: Session, request: Request) -> dict:
    """Fase 12B: arranque rápido de Sistema.

    Por defecto evita recalcular todos los checks pesados en cada entrada.
    La vista completa sigue disponible con ?full=1 y los endpoints técnicos.
    """
    ...
    phase7 = {
        ...
        "phase": "Fase 12B · Sistema liviano",
        "bad_count": 0,
    ...
    data = {
        ...
        "operational": {"ok": True, "score": 95 if db_ok else 60, "recommendation": "Arranque rápido activo; checks pesados bajo demanda.", "phase": "Fase 12B · performance y seguridad base", "rows": operational_rows},
        "phase7": phase7,
        "phase9": phase9,
        "phase11": phase11_center_summary(db),
