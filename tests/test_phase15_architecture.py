...
def test_settings_load_without_env_crash():
    ...
    loaded = settings.load_settings("1.14.0")
    assert loaded.app_version == "1.14.0"
...
def test_version_unified():
    ...
    assert 'APP_VERSION = "1.14.0"' in main_text
    assert 'APP_BUILD = "Fjord VI 1.14.0"' in main_text
